...
![]([https://github.com/Emptybottlecup/java-filmorate/blob/add-database/database_scheme.png](https://github.com/Emptybottlecup/java-filmorate/blob/add-database/database_sheme.png))
