...
public class FriendsRepository extends BaseRepository<Friends> {
    private static final String QUERY_GET_USER_FRIENDS = "SELECT * FROM friends WHERE id_user = ?";
    private static final String QUERY_ADD_NEW_FRIENDS_REQUEST = "INSERT INTO friends (id_user, id_friend_user, is_confirmed)" +
            "VALUES (?,?,?)";
    private static final String QUERY_GET_FRIENDS_CONNECTIONS_TWO_USERS = "SELECT * FROM friends WHERE id_user = ? AND id_friend_user = ?";
    private static final String QUERY_DELETE_FRIEND_CONNECTION = "DELETE FROM friends WHERE id_user = ? AND id_friend_user = ?";
